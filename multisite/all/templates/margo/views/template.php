...
<head>
  ...
  <!-- Bootstrap CSS  -->
  <link rel="stylesheet" href="<?php echo base_url('sites/all/themes/margo/')?>/asset/css/bootstrap.min.css" type="text/css" media="screen">

  <!-- Font Awesome CSS -->
  <link rel="stylesheet" href="<?php echo base_url('sites/all/themes/margo/')?>/css/font-awesome.min.css" type="text/css" media="screen">

  <!-- Slicknav -->
  <link rel="stylesheet" type="text/css" href="<?php echo base_url('sites/all/themes/margo/')?>/css/slicknav.css" media="screen">

  <!-- Margo CSS Styles  -->
  <link rel="stylesheet" type="text/css" href="<?php echo base_url('sites/all/themes/margo/')?>/css/style.css" media="screen">

  <!-- Responsive CSS Styles  -->
  <link rel="stylesheet" type="text/css" href="<?php echo base_url('sites/all/themes/margo/')?>/css/responsive.css" media="screen">

  <!-- Css3 Transitions Styles  -->
  <link rel="stylesheet" type="text/css" href="<?php echo base_url('sites/all/themes/margo/')?>/css/animate.css" media="screen">

  <!-- Color CSS Styles  -->
  <link rel="stylesheet" type="text/css" href="<?php echo base_url('sites/all/themes/margo/')?>/css/colors/jade.css" title="jade" media="screen" />
  <link rel="stylesheet" type="text/css" href="<?php echo base_url('sites/all/themes/margo/')?>/css/colors/red.css" title="red" media="screen" />
  <link rel="stylesheet" type="text/css" href="<?php echo base_url('sites/all/themes/margo/')?>/css/colors/green.css" title="green" media="screen" />
  <link rel="stylesheet" type="text/css" href="<?php echo base_url('sites/all/themes/margo/')?>/css/colors/blue.css" title="blue" media="screen" />
  <link rel="stylesheet" type="text/css" href="<?php echo base_url('sites/all/themes/margo/')?>/css/colors/beige.css" title="beige" media="screen" />
  <link rel="stylesheet" type="text/css" href="<?php echo base_url('sites/all/themes/margo/')?>/css/colors/cyan.css" title="cyan" media="screen" />
  <link rel="stylesheet" type="text/css" href="<?php echo base_url('sites/all/themes/margo/')?>/css/colors/orange.css" title="orange" media="screen" />
  <link rel="stylesheet" type="text/css" href="<?php echo base_url('sites/all/themes/margo/')?>/css/colors/peach.css" title="peach" media="screen" />
  <link rel="stylesheet" type="text/css" href="<?php echo base_url('sites/all/themes/margo/')?>/css/colors/pink.css" title="pink" media="screen" />
  <link rel="stylesheet" type="text/css" href="<?php echo base_url('sites/all/themes/margo/')?>/css/colors/purple.css" title="purple" media="screen" />
  <link rel="stylesheet" type="text/css" href="<?php echo base_url('sites/all/themes/margo/')?>/css/colors/sky-blue.css" title="sky-blue" media="screen" />
  <link rel="stylesheet" type="text/css" href="<?php echo base_url('sites/all/themes/margo/')?>/css/colors/yellow.css" title="yellow" media="screen" />

  <!-- Margo JS  -->
  <script type="text/javascript" src="<?php echo base_url('sites/all/themes/margo/')?>/js/jquery-2.1.4.min.js"></script>
  <script type="text/javascript" src="<?php echo base_url('sites/all/themes/margo/')?>/js/jquery.migrate.js"></script>
  <script type="text/javascript" src="<?php echo base_url('sites/all/themes/margo/')?>/js/modernizrr.js"></script>
  <script type="text/javascript" src="<?php echo base_url('sites/all/themes/margo/')?>/asset/js/bootstrap.min.js"></script>
  <script type="text/javascript" src="<?php echo base_url('sites/all/themes/margo/')?>/js/jquery.fitvids.js"></script>
  <script type="text/javascript" src="<?php echo base_url('sites/all/themes/margo/')?>/js/owl.carousel.min.js"></script>
  <script type="text/javascript" src="<?php echo base_url('sites/all/themes/margo/')?>/js/nivo-lightbox.min.js"></script>
  <script type="text/javascript" src="<?php echo base_url('sites/all/themes/margo/')?>/js/jquery.isotope.min.js"></script>
  <script type="text/javascript" src="<?php echo base_url('sites/all/themes/margo/')?>/js/jquery.appear.js"></script>
  <script type="text/javascript" src="<?php echo base_url('sites/all/themes/margo/')?>/js/count-to.js"></script>
  <script type="text/javascript" src="<?php echo base_url('sites/all/themes/margo/')?>/js/jquery.textillate.js"></script>
  <script type="text/javascript" src="<?php echo base_url('sites/all/themes/margo/')?>/js/jquery.lettering.js"></script>
  <script type="text/javascript" src="<?php echo base_url('sites/all/themes/margo/')?>/js/jquery.easypiechart.min.js"></script>
  <script type="text/javascript" src="<?php echo base_url('sites/all/themes/margo/')?>/js/jquery.nicescroll.min.js"></script>
  <script type="text/javascript" src="<?php echo base_url('sites/all/themes/margo/')?>/js/jquery.parallax.js"></script>
  <script type="text/javascript" src="<?php echo base_url('sites/all/themes/margo/')?>/js/mediaelement-and-player.js"></script>
  <script type="text/javascript" src="<?php echo base_url('sites/all/themes/margo/')?>/js/jquery.slicknav.js"></script>
...
<body style="background-image: url('http://ci.mhs.tut:8888/sites/all/themes/margo/images/patterns/3.png');">
  ...
  <div id="container" class="boxed-page">
    ...
    <section id="home">
      ...
      <div id="main-slide" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          ...
          <!--/ Carousel item end -->
          <div class="item">
            <img class="img-responsive" src="<?php echo base_url('sites/all/themes/margo/')?>/images/slider/bg2.jpg" alt="slider">
            <div class="slider-content">
              <div class="col-md-12 text-center">
                <h2 class="animated4">
          ...
          <!--/ Carousel item end -->
          <div class="item">
            <img class="img-responsive" src="<?php echo base_url('sites/all/themes/margo/')?>/images/slider/bg3.jpg" alt="slider">
            <div class="slider-content">
              <div class="col-md-12 text-center">
    ...
    <div class="section full-width-portfolio" style="border-top:0; border-bottom:0; background:#fff;">
      ...
      <ul id="portfolio-list" data-animated="fadeIn">
        <li>
          <img src="<?php echo base_url('sites/all/themes/margo/')?>/images/portfolio-1/1.png" alt="" />
        ...
        <li>
          <img src="<?php echo base_url('sites/all/themes/margo/')?>/images/portfolio-1/2.png" alt="" />
          <div class="portfolio-item-content">
        ...
        <li>
          <img src="<?php echo base_url('sites/all/themes/margo/')?>/images/portfolio-1/3.png" alt="" />
          <div class="portfolio-item-content">
        ...
        <li>
          <img src="<?php echo base_url('sites/all/themes/margo/')?>/images/portfolio-1/4.png" alt="" />
          <div class="portfolio-item-content">
        ...
        <li>
          <img src="<?php echo base_url('sites/all/themes/margo/')?>/images/portfolio-1/5.png" alt="" />
          <div class="portfolio-item-content">
        ...
        <li>
          <img src="<?php echo base_url('sites/all/themes/margo/')?>/images/portfolio-1/6.png" alt="" />
          <div class="portfolio-item-content">
        ...
        <li>
          <img src="<?php echo base_url('sites/all/themes/margo/')?>/images/portfolio-1/7.png" alt="" />
          <div class="portfolio-item-content">
            <span class="header">Monocle issue 69</span>
            <p class="body">web develpment, design</p>
          </div>
        ...
        <li>
          <img src="<?php echo base_url('sites/all/themes/margo/')?>/images/portfolio-1/8.png" alt="" />
          <div class="portfolio-item-content">
            <span class="header">Monocle issue 69</span>
            <p class="body">web develpment, design</p>
          </div>
        ...
        <li>
          <img src="<?php echo base_url('sites/all/themes/margo/')?>/images/portfolio-1/9.png" alt="" />
          <div class="portfolio-item-content">
            <span class="header">Monocle issue 69</span>
            <p class="body">web develpment, design</p>
          </div>
        ...
        <li>
          <img src="<?php echo base_url('sites/all/themes/margo/')?>/images/portfolio-1/10.png" alt="" />
          <div class="portfolio-item-content">
            <span class="header">Monocle issue 69</span>
            <p class="body">web develpment, design</p>
          </div>
        ...
        <li>
          <img src="<?php echo base_url('sites/all/themes/margo/')?>/images/portfolio-1/11.png" alt="" />
          <div class="portfolio-item-content">
            <span class="header">Monocle issue 69</span>
            <p class="body">web develpment, design</p>
          </div>
        ...
        <li>
          <img src="<?php echo base_url('sites/all/themes/margo/')?>/images/portfolio-1/12.png" alt="" />
          <div class="portfolio-item-content">
            <span class="header">Monocle issue 69</span>
            <p class="body">web develpment, design</p>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6 col-xs-12" data-animation="fadeIn" data-animation-delay="03">
            <div class="team-member modern">
              ...
              <div class="member-photo">
                <img alt="" src="<?php echo base_url('sites/all/themes/margo/')?>/images/team/face_1.png" />
          ...
          <div class="col-md-3 col-sm-6 col-xs-12" data-animation="fadeIn" data-animation-delay="04">
            <div class="team-member modern">
              <!-- Memebr Photo, Name & Position -->
              <div class="member-photo">
                <img alt="" src="<?php echo base_url('sites/all/themes/margo/')?>/images/team/face_2.png" />
          ...
          <div class="col-md-3 col-sm-6 col-xs-12" data-animation="fadeIn" data-animation-delay="05">
            <div class="team-member modern">
              <!-- Memebr Photo, Name & Position -->
              <div class="member-photo">
                <img alt="" src="<?php echo base_url('sites/all/themes/margo/')?>/images/team/face_3.png" />
          ...
          <div class="col-md-3 col-sm-6 col-xs-12" data-animation="fadeIn" data-animation-delay="06">
            <div class="team-member modern">
              <!-- Memebr Photo, Name & Position -->
              <div class="member-photo">
                <img alt="" src="<?php echo base_url('sites/all/themes/margo/')?>/images/team/face_4.png" />
          ...
          <div class="our-clients">
            <div class="clients-carousel custom-carousel touch-carousel navigation-3" data-appeared-items="5" data-navigation="true">
              ...
              <div class="client-item item">
                <a href="#"><img src="<?php echo base_url('sites/all/themes/margo/')?>/images/c1.png" alt="" /></a>
              </div>

              <!-- Client 2 -->
              <div class="client-item item">
                <a href="#"><img src="<?php echo base_url('sites/all/themes/margo/')?>/images/c2.png" alt="" /></a>
              </div>

              <!-- Client 3 -->
              <div class="client-item item">
                <a href="#"><img src="<?php echo base_url('sites/all/themes/margo/')?>/images/c3.png" alt="" /></a>
              </div>

              <!-- Client 4 -->
              <div class="client-item item">
                <a href="#"><img src="<?php echo base_url('sites/all/themes/margo/')?>/images/c4.png" alt="" /></a>
              </div>

              <!-- Client 5 -->
              <div class="client-item item">
                <a href="#"><img src="<?php echo base_url('sites/all/themes/margo/')?>/images/c5.png" alt="" /></a>
              </div>

              <!-- Client 6 -->
              <div class="client-item item">
                <a href="#"><img src="<?php echo base_url('sites/all/themes/margo/')?>/images/c6.png" alt="" /></a>
              </div>

              <!-- Client 7 -->
              <div class="client-item item">
                <a href="#"><img src="<?php echo base_url('sites/all/themes/margo/')?>/images/c7.png" alt="" /></a>
              </div>

              <!-- Client 8 -->
              <div class="client-item item">
                <a href="#"><img src="<?php echo base_url('sites/all/themes/margo/')?>/images/c8.png" alt="" /></a>
              </div>
        ...
        <div class="row footer-widgets">
              ...
              <ul class="flickr-list">
                <li>
                  <a href="images/flickr-01.jpg" class="lightbox">
                    <img alt="" src="<?php echo base_url('sites/all/themes/margo/')?>/images/flickr-01.jpg">
                  </a>
                </li>
                <li>
                  <a href="images/flickr-02.jpg" class="lightbox">
                    <img alt="" src="<?php echo base_url('sites/all/themes/margo/')?>/images/flickr-02.jpg">
                  </a>
                </li>
                <li>
                  <a href="images/flickr-03.jpg" class="lightbox">
                    <img alt="" src="<?php echo base_url('sites/all/themes/margo/')?>/images/flickr-03.jpg">
                  </a>
                </li>
                <li>
                  <a href="images/flickr-04.jpg" class="lightbox">
                    <img alt="" src="<?php echo base_url('sites/all/themes/margo/')?>/images/flickr-04.jpg">
                  </a>
                </li>
                <li>
                  <a href="images/flickr-05.jpg" class="lightbox">
                    <img alt="" src="<?php echo base_url('sites/all/themes/margo/')?>/images/flickr-05.jpg">
                  </a>
                </li>
                <li>
                  <a href="images/flickr-06.jpg" class="lightbox">
                    <img alt="" src="<?php echo base_url('sites/all/themes/margo/')?>/images/flickr-06.jpg">
                  </a>
                </li>
                <li>
                  <a href="images/flickr-07.jpg" class="lightbox">
                    <img alt="" src="<?php echo base_url('sites/all/themes/margo/')?>/images/flickr-07.jpg">
                  </a>
                </li>
                <li>
                  <a href="images/flickr-08.jpg" class="lightbox">
                    <img alt="" src="<?php echo base_url('sites/all/themes/margo/')?>/images/flickr-08.jpg">
                  </a>
                </li>
                <li>
                  <a href="images/flickr-09.jpg" class="lightbox">
                    <img alt="" src="<?php echo base_url('sites/all/themes/margo/')?>/images/flickr-09.jpg">
                  </a>
                </li>
              </ul>
            </div>
          ...
          <div class="col-md-3 col-xs-12">
            <div class="footer-widget contact-widget">
              <h4><img src="<?php echo base_url('sites/all/themes/margo/')?>/images/footer-margo.png" class="img-responsive" alt="Footer Logo" /></h4>
  ...
  <script type="text/javascript" src="<?php echo base_url('sites/all/themes/margo/')?>/js/script.js"></script>
