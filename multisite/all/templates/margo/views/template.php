...
<head>
  ...
  <!-- Color CSS Styles  -->
  <link rel="stylesheet" type="text/css" href="<?php echo base_url('sites/'.MULTISITE_MAIN_DOMAIN.'/'.MULTISITE_SITE_DOMAIN.'/themes/margo/')?>/css/colors/site-css.css" title="site-css" media="screen" />
